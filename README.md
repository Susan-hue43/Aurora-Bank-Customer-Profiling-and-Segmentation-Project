...
* [Focus Areas](#focus-areas)
    * [Customer Demographics](#1-customer-demographics)
    * [Credit Score Analysis](#2-credit-score-analysis)
    * [Financial Health & Risk Assessment](#3-financial-health--risk-assessment)
    * [Card Ownership & Usage Trends](#4-card-ownership--usage-trends)
...
## Skills Demonstrated
*Tool: SSMS (SQL Server Management Studio), PowerBI*
...
- **Data Visualization (via PowerBI)**
...
* The presence of financial stress in a large portion of the customer base could hinder product uptake or reduce eligibility for premium services.
